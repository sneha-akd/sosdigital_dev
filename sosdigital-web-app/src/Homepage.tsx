...
function Homepage() {
  return <>
    ...
    <div className="container px-4 py-5  ">
      <h4 className="pb-2 border-bottom">Start Your Learning Journey Now!</h4>

      <div className="row row-cols-1 row-cols-md-2 align-items-md-center g-5 py-5">
        <div className="col d-flex flex-column align-items-start gap-2">
          <h5 className=" text-body-emphasis">Organize Course Structure</h5>
          <p className="text-body-secondary">
            <li>JEE Preparation</li>
            <li>NEET Preparation</li>
            <li>12TH Preparation</li>
            The course structure should be designed in a way that supports JEE Main and JEE Advanced preparation, as well as optional NEET preparation for PCMB students.
          </p>
          ...
          <div className="row row-cols-1 row-cols-sm-2 g-4">
            <div className="col d-flex flex-column gap-2">
              <div className="feature-icon-small d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-4 rounded-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" className="bi bi-book" viewBox="0 0 16 16">
              ...
              <h5 className="mb-0 text-body-emphasis">Mock Tests & Practice Exams</h5>
              <p className="text-body-secondary">Mock tests and practice exams are integral components of online education, providing students with opportunities to assess their understanding, prepare for final exams, and reinforce their learning. .</p>
            </div>
            ...
            <div className="col d-flex flex-column gap-2">
              ...
              <h5 className=" mb-0 text-body-emphasis">Instant Test Results with Comprehensive Solutions</h5>
              <p className="text-body-secondary">Providing instant test results with comprehensive solutions is one of the most valuable features of modern online education platforms.</p>
            </div>

            <div className="col d-flex flex-column gap-2">
              <div className="feature-icon-small d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-4 rounded-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" className="bi bi-chat-right-text" viewBox="0 0 16 16">
              ...
              <h5 className=" mb-0 text-body-emphasis">Interactive Learning Materials</h5>
              <p className="text-body-secondary">Interactive learning materials are educational tools that engage students through active participation, rather than passive reception.  </p>
            </div>

            <div className="col d-flex flex-column gap-2">
              <div className="feature-icon-small d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-4 rounded-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" className="bi bi-camera-video" viewBox="0 0 16 16">
                  <path fill-rule="evenodd" d="M0 5a2 2 0 0 1 2-2h7.5a2 2 0 0 1 1.983 1.738l3.11-1.382A1 1 0 0 1 16 4.269v7.462a1 1 0 0 1-1.406.913l-3.111-1.382A2 2 0 0 1 9.5 13H2a2 2 0 0 1-2-2zm11.5 5.175 3.5 1.556V4.269l-3.5 1.556zM2 4a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h7.5a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1z" />
                </svg>
                <use xlinkHref="#table"></use>

              </div>
              <h5 className=" mb-0 text-body-emphasis">Access to Recorded Sessions</h5>
              <p className="text-body-secondary">its sought-after features in online education.It provides students with the flexibility to revisit lectures,review complex topics and catch up on content missed due to scheduling conflicts time differences.</p>
            </div>
          </div>
        </div>
      </div>
